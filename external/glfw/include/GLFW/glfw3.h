 ...
 *
 *  @param[in] window The window that received the event.
 *  @param[in] xoffset The scroll m_attribOffset along the x-axis.
 *  @param[in] yoffset The scroll m_attribOffset along the y-axis.
 *
 *  @sa @ref scrolling
 ...
 *  the m_attribOffset along a particular coordinate axis, the retrieved values will
